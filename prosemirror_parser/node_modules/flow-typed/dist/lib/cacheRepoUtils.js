...
async function verifyCLIVersion() {
  ...
  const metadata = JSON.parse(String((await _node.fs.readFile(metadataPath))));
  ...
  const thisCLIPkgJson = JSON.parse(String((await _node.fs.readFile(thisCLIPkgJsonPath))));
