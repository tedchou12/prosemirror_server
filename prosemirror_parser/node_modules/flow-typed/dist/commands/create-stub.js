...
async function run(args) {
  ...
  const results = await Promise.all(packages.map(pkg => {
    ...
    return (0, _stubUtils.createStub)(projectRoot, packageName, version, Boolean(args.overwrite), Boolean(args.typescript), String(args.libdefDir), Number(args.maxDepth));
  }));
